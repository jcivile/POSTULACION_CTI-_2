...
<body>
  ...
  <div class="mb-3 mt-3">
    ...
    <input type="id" class="form-control" id="id" placeholder="ID" name="id" value=" <?php  echo $talleres['id_persona']    ?> " >
  </div>

  <div class="mb-3">
    <label for="nombre" class="form-label">Nombre:</label>
    <input type="nombre" class="form-control" id="nombre" placeholder="nombre" name="nombre" value=" <?php  echo $talleres['nombres']    ?> ">
  </div>
  
  <div class="mb-3">
    <label for="apellido" class="form-label">Apellido:</label>
    <input type="apellido" class="form-control" id="apellido" placeholder="apellido" name="apellido" value=" <?php  echo $talleres['apellidos']    ?> ">
  </div>
