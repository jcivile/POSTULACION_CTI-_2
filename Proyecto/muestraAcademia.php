...
<div class="espacio-tabla">
  ...
  <thead>
    <tr>
      ...
      <th scope="col">Titulo Programa</th>
...
?>
    <tr>
      ...
      <td><?php  echo $mostrar['Diploma'] ?></td>
      <td><?php  echo $mostrar['FechaR'] ?></td>
      <td><?php  echo $mostrar['TituloPrograma'] ?></td>
      <td><?php  echo $mostrar['Istitucion'] ?></td>
      
      <td> <a href="editar.php?id=<?php   echo $mostrar ['ID']  ?>" class="btn btn-success" >  Editar   </a> 
      |
      <a href="confEliminar.php?id=<?php   echo $mostrar ['ID']  ?>" class="btn btn-danger" >  Eliminar   </a>
