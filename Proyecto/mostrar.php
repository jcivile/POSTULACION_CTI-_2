...
?>
    <tr>
      ...
      <td> <a href="editar.php?id=<?php   echo $mostrar ['id_persona']  ?>" class="btn btn-success" >  Editar   </a> 
      |
      <a href="confEliminar.php?id=<?php   echo $mostrar ['id_persona']  ?>" class="btn btn-danger" >  Eliminar   </a>
