...
<body>
  ...
  <header class="enca">
    <div class="wrap"> 
      ...
      <nav>
          <a href="DatosPersonales.php">Datos 
          </a>
  ...
  <button type="submit" class="btn btn-primary" name="confirmar" id="confirmar">Eliminar</button>
    <label for="stateElminar" name="stateEliminar" id="stateEliminar"></label>
